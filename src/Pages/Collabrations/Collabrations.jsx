    ...
    <div className="collaborations-container">
      ...
      <div className="collaborations-content">
        ...
        <div className="collaboration-card">
          ...
          <p>
            Join Me in building a platform that connects skilled workers with customers. I am looking for collaborators in front-end,back-end,dataBase etc and marketing to take this platform to the next level.
          </p>
